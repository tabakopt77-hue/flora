...
export const BLOG_POSTS: BlogPost[] = [
  {
    ...
    content: (
      <>
        ...
        <p>
          В Aura Flora мы чтим традиции и верим, что каждый букет, подаренный в этот день, — это не просто цветы, а символ уважения, признания и любви.
        </p>
      </>
    ),
    ...
    content: (
        <>
            ...
            <p>
                ...
                В Aura Flora мы создаем композиции, которые можно "читать" как открытую книгу.
            </p>
            <figure>
                <img 

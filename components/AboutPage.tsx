      ...
      <section className="relative h-[60vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center max-w-4xl px-4">
           ...
           <p className="text-lg text-emerald-100/80 max-w-2xl mx-auto leading-relaxed">
             Aura Flora — это первый в мире маркетплейс, объединивший тепло рук лучших флористов и точность искусственного интеллекта.
           </p>
        </div>
      </section>
            ...
            <div className="flex flex-col md:flex-row items-center gap-8 md:gap-16">
               ...
               <div className="w-full md:w-1/2 space-y-6">
                  ...
                  <div className="prose prose-lg text-gray-600">
                    ...
                    <p>
                      Сегодня Aura Flora — это сообщество из 500+ мастеров, объединенных общей платформой качества.
                    </p>
                  </div>
                  <Link to="/catalog">
